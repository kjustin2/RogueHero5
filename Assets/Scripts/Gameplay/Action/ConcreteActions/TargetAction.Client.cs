...
namespace Unity.BossRoom.Gameplay.Actions
{
    public partial class TargetAction
    {
        ...
        void ValidateReticule(ClientCharacter parent, NetworkObject targetObject)
        {
            ...
            bool hostile = targetObject.TryGetComponent(out ServerCharacter targetCharacter)
                ? ActionUtils.IsValidActionTarget(parent.serverCharacter, targetCharacter, false)
                : target_isnpc != myself_isnpc;
