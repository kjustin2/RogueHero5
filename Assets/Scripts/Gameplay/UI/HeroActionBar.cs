...
namespace Unity.BossRoom.Gameplay.UI
{
    ...
    public class HeroActionBar : MonoBehaviour
    {
        ...
        void RegisterInputSender(ClientPlayerAvatar clientPlayerAvatar)
        {
            ...
            m_InputSender.actionLoadoutModifiedCallback += ActionLoadoutModifiedCallback;
        ...
        void ActionLoadoutModifiedCallback()
        {
            UpdateAllActionButtons();
        }
        ...
        void UpdateAllActionButtons()
        {
            ...
            UpdateActionButton(m_ButtonInfo[ActionButtonType.BasicAction], action1,
                m_InputSender.actionState1 == null || m_InputSender.actionState1.selectable);
            ...
            UpdateActionButton(m_ButtonInfo[ActionButtonType.Special1], action2,
                m_InputSender.actionState2 == null || m_InputSender.actionState2.selectable);
            ...
            UpdateActionButton(m_ButtonInfo[ActionButtonType.Special2], action3,
                m_InputSender.actionState3 == null || m_InputSender.actionState3.selectable);
        }
        ...
        void OnButtonClickedDown(ActionButtonType buttonType)
        {
            ...
            if (m_ButtonInfo[buttonType].CurAction == null)
            {
                return;
            }
