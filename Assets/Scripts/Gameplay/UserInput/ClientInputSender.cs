...
namespace Unity.BossRoom.Gameplay.UserInput
{
    ...
    public class ClientInputSender : NetworkBehaviour
    {
        ...
        public System.Action actionLoadoutModifiedCallback;
        ...
        bool GetActionRequestForTarget(Transform hit, ActionID actionID, SkillTriggerStyle triggerStyle, out ActionRequestData resultData)
        {
            ...
            if (targetNetObj.TryGetComponent<ServerCharacter>(out var serverCharacter))
            {
                ...
                if (actionID == GetPrimaryActionID() && triggerStyle == SkillTriggerStyle.MouseClick)
                {
        ...
        void Update()
        {
            if (!EventSystem.current.IsPointerOverGameObject() && m_CurrentSkillInput == null)
            {
                ...
                if (m_Skill1Action.action.WasPressedThisFrame() && actionState1 != null)
                {
        ...
        void UpdateAction1()
        {
            ...
            {
                actionState1.SetActionState(GetPrimaryActionID());
            }
        ...
        ActionID GetPrimaryActionID()
        {
            var campaignLoadout = DuelSessionState.Instance;
            var campaignBasicAction = campaignLoadout?.GetCampaignLoadoutAction(0);
            return campaignLoadout != null && campaignLoadout.IsCampaign && campaignBasicAction != null
                ? campaignBasicAction.ActionID
                : CharacterClass.Skill1.ActionID;
        }

        void ApplyCampaignLoadout()
        {
            if (DuelSessionState.Instance == null ||
                !DuelSessionState.Instance.TryGetCampaignLoadout(CharacterClass, out var loadout))
            {
                return;
            }
            ...
            if (loadout[0] != null)
            {
                ...
                actionState1.SetActionState(loadout[0].ActionID);
            }
            ...
            if (loadout[1] != null)
            {
                ...
                actionState2.SetActionState(loadout[1].ActionID);
            }
            ...
            if (loadout[2] != null)
            {
                ...
                actionState3.SetActionState(loadout[2].ActionID);
            }

            actionLoadoutModifiedCallback?.Invoke();
        }
