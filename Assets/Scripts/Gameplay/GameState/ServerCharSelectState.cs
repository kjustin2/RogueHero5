    ...
    public class ServerCharSelectState : GameStateBehaviour
    {
        ...
        void SaveSessionResults()
        {
            foreach (NetworkCharSelection.SessionPlayerState playerInfo in networkCharSelection.sessionPlayers)
            {
                ...
                {
                    var avatarConfiguration = networkCharSelection.AvatarConfiguration[playerInfo.SeatIdx];
                    ...
                    persistentPlayer.NetworkAvatarGuidState.AvatarGuid.Value =
                        avatarConfiguration.Guid.ToNetworkGuid();

                    m_DuelSessionState.InitializeCampaignLoadout(avatarConfiguration.CharacterClass);
                }
            }
        }
